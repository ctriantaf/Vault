...
class DeleteerrorDialog(Gtk.Dialog):
    __gtype_name__ = "DeleteerrorDialog"
    ...
    def finish_initializing(self, builder):
        ...
        and creating a DeleteerrorDialog object with it in order to
        finish initializing the start of the new DeleteerrorDialog
        instance.
        """
