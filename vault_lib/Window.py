...
import logging
logger = logging.getLogger('vault_lib')

from . helpers import get_builder, show_uri, get_help_uri

# This class is meant to be subclassed by VaultWindow.  It provides
...
class Window(Gtk.Window):
    ...
    def __new__(cls):
        ...
        Returns a fully instantiated BaseVaultWindow object.
        """
        builder = get_builder('VaultWindow')
        new_object = builder.get_object("vault_window")
    ...
    def finish_initializing(self, builder):
        ...
        and creating a VaultWindow object with it in order to finish
        initializing the start of the new VaultWindow instance.
        """
        ...
        try:
            ...
            LaunchpadIntegration.set_sourcepackagename('vault')
        except ImportError:
            pass
    ...
    def on_mnu_about_activate(self, widget, data=None):
        """Display the about box for vault."""
    ...
    def on_mnu_preferences_activate(self, widget, data=None):
        """Display the preferences window for vault."""
    ...
    def on_mnu_close_activate(self, widget, data=None):
        """Signal handler for closing the VaultWindow."""
        self.destroy()

    def on_destroy(self, widget, data=None):
        """Called when the VaultWindow is closed."""
